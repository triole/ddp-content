...
**Mindestanforderung III.a):**\\ **Sichern von Daten und Begleitmaterialien im Projektverlauf**

**III. Themenbereich: Sichern im Projekt**

# Mindestanforderung

Die Daten (siehe ***Glossar***) und ihre Begleitmaterialen (siehe ***Glossar***) werden im Projektverlauf systematisch gespeichert, in einem zugriffsgeschützten Back-Up-System gesichert und ihre Nutzbarkeit dauerhaft gewährleistet.
...
Eine adäquate Strategie für die Speicherung der im Projekt verwendeten Daten und ihre Begleitmaterialien schützt diese vor versehentlichem Verlust, Überschreiben etc. und gewährleistet die Zugänglichkeit zu den Dateien für alle am Projekt beteiligten Personen. Die Planung und Umsetzung einer Speicherstrategie geht einher mit dem allgemeinen Projektmanagement und den im Projekt bestehenden Regelungen zur Speicherung, Benennung, Versionierung und Sicherung von Dateien.
...
4.	Zum Schutz der Daten und Begleitmaterialien vor versehentlichem
	...
	-	den Rückgriff auf institutionelle Back-Up-Systeme (siehe\***Standard* *4-a***),

	-	die Nutzung von Cloud-Diensten zum Speichern von Dateien mit entsprechenden Back-Up-Systemen,

	-	die Nutzung externer Back-Up-Systeme, wie z. B. einem Repositorium zur Sicherung von Daten und Begleitmaterialien im Projektverlauf, oder
...
-	im jeweiligen Back-Up-System die notwendige Speicherkapazität verfügbar ist, ausreichend Sicherungskopien erstellt werden, mindestens eine Sicherungskopie auf einem externen Speichermedium liegt, d. h. getrennt von den Originaldaten und den anderen Sicherungskopien aufbewahrt wird, und die Datenintegrität der Sicherungskopien gewährleistet ist (siehe ***weiterführende Ressourcen zur Kontrolle der Datenintegrität***),

-	sie jederzeit Zugang zu den Back-Ups haben und das Vorgehen zum Erhalt der Sicherungskopien klar definiert ist.
...
-	die digitale Dokumentation entsprechender Informationen, z. B. im Rahmen des Einwilligungsmanagements (siehe ***Modul IV.a) Rechtliche Vorgaben des Datenschutzes***).
